...
The node listens to the following messages:
   ...
   o joy/set_feedback
                 Topic that listens to sensor_msgs/JoyFeedbackArray messages.
                 This controls the LEDs and the Rumble.  There are 4 LEDs with ids of 0 through 3.
                 The "Player 1" LED is id 0; the "Player 4" LED is id3.
                 The Wiimote only has one rumble, so it is id 0.
   o imu/calibrate
                ...
                for irSensorIndx in range(NUM_IR_SENSORS):
                    if irSources[irSensorIndx] is not None:
                        ...
                        try:
                            ...
                            msg.ir_tracking.append(IrSourceInfo(State.INVALID_FLOAT,
                                                                State.INVALID_FLOAT,
                                                                State.INVALID))
